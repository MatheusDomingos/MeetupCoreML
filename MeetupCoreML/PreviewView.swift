...
class PreviewView: UIViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
    
    @IBOutlet weak var ivPreview: UIImageView!
    @IBOutlet weak var lbRotule: UILabel!
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        ...
        lbRotule.text = "Analisando a imagem..."
        ...
        lbRotule.text = "Eu penso que é uma  \(prediction.classLabel)."
    }
